...
const CompanyHero = ({ data, heroImage }) => {
   useEffect(() => {
  ...
  return (
    <>
    <section className={`viewport cream-color ${styles.hero}`}>
